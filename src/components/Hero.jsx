...
export default function Hero() {
  return (
    <section className="flex bg-gradient-to-r from-customBlue from-20%  to-[#0263A8] to-100% flex-col gap-3 justify-center items-center lg:py-12 py-6 text-center px-4">
      <h1 className="lg:text-4xl text-2xl text-white font-montserrat">
        Compara. Cumpara. Economiseste.
      </h1>
      <h2 className="lg:text-lg text-md text-center  mb-6 text-white font-montserrat">
      ...
      <Link href="/produse">
        <button className="px-4 py-1 bg-white text-gray-600 rounded-md mt-3 font-poppins">
